...
def run_querry(user_querry, json_file):
    ...
    messages=[
        ...
        "When analysing the JSON file, consider the following context, that the user wants to be considered. This will be the context question for creating the plots:" + user_promt},
        {
            "role": "user",
            # "content": f"{json_file}"
